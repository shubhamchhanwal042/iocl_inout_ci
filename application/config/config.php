...
// C:\Xamp\htdocs\inout_ci_test\application\config\config.php

// $config['base_url'] = 'http://localhost/inout_ci_test/';
// $config['api_base_url'] = 'http://localhost/hpcl_inout_api/';
...
/*  https://08d7-2405-201-1006-2801-f1e0-2893-f54b-10c5.ngrok-free.app  https://github.com/sonal-kiran-bhirud/hpcl_inout_org.git
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
|
...
$config['sess_driver'] = 'files';
$config['sess_cookie_name'] = 'iocl_inout_session';
$config['sess_samesite'] = 'Lax';
