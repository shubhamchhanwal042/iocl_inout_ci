...
<body>
    ...
    <div class="wrapper d-flex">
        ...
        <div class="container-fluid">
                ...
                <div class="card " id="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-1">
                                    <a class="btn btn-primary" onclick="searchGatePass()"><i
                ...
                <div class="content border p-3 mb-3 mt-4" id="content" style="display: none;">
                    ...
                    <div class="header d-flex align-items-center justify-content-between border-bottom ">
                        ...
                        <div class="header-content text-center flex-grow-1">
                            <p class="fs-6 text-center fw-bold">Indian Oil
                                Corporation
                                Limited<br>
                                Sinnar LPG Bottling Plant, G-6, MIDC, MIDC Area, Malegaon, Maharashtra 422113 GSTIN -
                                27AAACH1118B1ZC</p>
                    ...
                    <div id="licensed-entry-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 fs-6">
                                ...
                                <p style="font-weight: bold;">Access: <span id="access" style="color:red;">
    ...
    const searchGatePass = async () => {
        ...
        try {
            ...
            if (data.status === 'not_found') {
                ...
                document.getElementById('visitor_status').textContent = data.visitor_status === '0' ?
                    'Pending' : 'Approved';
