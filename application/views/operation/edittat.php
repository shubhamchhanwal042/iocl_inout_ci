...
<body>
    ...
    <div class="wrapper d-flex overall-body">
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url().'Operation/UpdateTat'; ?>"
                            enctype="multipart/form-data">
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    <input type="hidden" name="id" value="<?php echo $tat['id']; ?> "
                                        class="form-control mb-4">

                                    <label for="token_no">Token Number :</label>
                                    <input type="text" name="token_no" value="<?php echo $tat['token_no']; ?> "
                                        class="form-control" placeholder="Token Number" readonly>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $tat['aadhar_no'];?>">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="aadhar_no" id="aadhar_no" class="form-control"
                                        ...
                                        maxlength="12" value="<?php echo $tat['aadhar_no']; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="mobile_no" id="mobile_no" class="form-control"
                                        ...
                                        maxlength="10" value="<?php echo $tat['mobile_no']; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="address" class="form-control" id="address"
                                        ...
                                        rows="3" placeholder="Enter Address"><?php echo $tat['address']; ?></textarea>
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a class="btn btn-secondary"
                                        href="<?php echo base_url().'OprId/'.$tat['id'] . '/tat'; ?>"><i
                                            class="fa-solid fa-id-card"></i> Id
                                        Card</a>
                                    <a href="<?php echo base_url() . 'Tat' ?>" class="btn btn-danger"><i
        ...
        <script>
        document.getElementById('page-title').innerHTML = "IOCL  INOUT | TAT";
     ...
     function confirmDelete(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropTat/'.$tat['id'];?>"; // Replace with your delete action or URL
            } else {
