...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
     ...
     <script>
          ...
          function fetchContractorWorkmen() {
               fetch("<?php echo base_url('Operation/FetchContractorWorkmen'); ?>")
                              ...
                              card.innerHTML = `
                                   <div class="card text-center" id="${uniqueCardId}">
                                        ...
                                        <div class="card-body">
                                             ...
                                             <a href="${result.full_name ? 'EditContractorWorkman/' + result.id : 'AddContractorWorkman/' + result.id}" class="btn btn-primary form-control ${buttonDisabled}">
          ...
          document.getElementById('contractor_workmanForm').addEventListener('submit', function (e) {
               ...
               fetch("<?php echo site_url('Operation/AddContractorWorkmanToken'); ?>", {
                    method: 'POST',
                    headers: {
                    ...
                    .then(response => response.json())
                    .then(data => {
                         fetchContractorWorkmen(); // Re-fetch workmen after adding
                    });
          });

          // Initial fetch of workmen on page load
          document.addEventListener('DOMContentLoaded', fetchContractorWorkmen);
     </script>
             <script>
