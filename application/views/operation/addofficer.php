            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                        <form method="post" action="<?php echo base_url().'Operation/InsertOfficer'?>" id="myform" enctype="multipart/form-data">

                        <input type="hidden" name="id" id="id" value="<?php echo $id;?>" hidden>
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    <label for="token_no">Token Number :</label>
                                    <input type="text" name="token_no" id="token_no" class="form-control" placeholder="Enter Token Number" value="<?php  echo $id;?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4"> 
                                    ...
                                    <input type="text" name="aadhar_no" id="aadhar_no"  oninput="this.value=this.value.replace(/[^0-9]/g,'')" size="12"
                                                  minlength="12" maxlength="12"  class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g,'');" size="12" minlength="12" maxlength="12" placeholder="Enter Aadhar Number" required>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="mobile_no" id="mobile_no" class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g,'')" size="10" minlength="10" maxlength="10" placeholder="Enter Mobile Number" required>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="address" class="form-control" id="address" rows="3" placeholder="Enter Address" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);" required></textarea>
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a href="<?php echo base_url().'Officer';?>" class="btn btn-danger"><i class="fa-solid fa-arrow-left"></i> Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
document.getElementById('navbar-title').innerHTML = "Add Officer Form <i class='fa-solid fa-users'></i>";
