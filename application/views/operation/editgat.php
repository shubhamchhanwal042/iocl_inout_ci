...
<body>
    ...
    <div class="wrapper d-flex overall-body">
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url().'Operation/UpdateGat'; ?>"
                            enctype="multipart/form-data">
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    <input type="hidden" name="id" value="<?php echo $gat['id']; ?> "
                                        class="form-control">

                                    <label for="token_no">Token Number :</label>
                                    <input type="text" id="token_no" name="token_no"
                                        value="<?php echo $gat['token_no']; ?> " class="form-control"
                                        placeholder="Token Number" readonly>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $gat['aadhar_no'];?>">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="aadhar_no" id="aadhar_no"
                                        ...
                                        value="<?php echo $gat['aadhar_no']; ?>" placeholder="Enter Aadhar Number"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="full_name" id="full_name"
                                        ...
                                        class="form-control" value="<?php echo $gat['full_name']; ?>"
                                        placeholder="Enter Full Name" onchange="validateIdcard()">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="mobile_no" id="mobile_no" class="form-control"
                                        ...
                                        maxlength="10" value="<?php echo $gat['mobile_no']; ?>"
                                        placeholder="Enter Mobile Number" onchange="validateIdcard()">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="address" id="address" class="form-control" rows="3"
                                        ...
                                        onchange="validateIdcard()"><?php echo $gat['address']; ?></textarea>
                                ...
                                <div class="ms-3 ">
                                    ...
                                    <a class="btn btn-secondary"
                                        href="<?php echo base_url().'OprId/'.$gat['id'] . '/gat'; ?>"><i
                                            class="fa-solid fa-id-card"></i> Id
                                        Card</a>

                                    <a href="<?php echo base_url() . 'Gat' ?>" class="btn btn-danger"><i
        ...
        document.getElementById('page-title').innerHTML = "IOCL  INOUT | GAT";
    ...
    if (!validateContact() || !validateAadharNo() || !validateName() || !validateAddr()) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropGat/'.$gat['id'];?>"; // Replace with your delete action or URL
            } else {
