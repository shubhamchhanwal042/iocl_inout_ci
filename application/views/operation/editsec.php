...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url().'Operation/UpdateSec'; ?>"
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="token_no" value="<?php echo $sec['token_no']; ?> "
                                        class="form-control" placeholder="Token Number" readonly>
                                </div>
                            </div> 
                            <input type="hidden" name="oldaadhar" value="<?php echo $sec['aadhar_no'];?>">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="aadhar_no" class="form-control" id="aadhar_no"
                                        ...
                                        maxlength="12" value="<?php echo $sec['aadhar_no']; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="full_name" class="form-control" id="full_name"
                                        ...
                                        value="<?php echo $sec['full_name']; ?>" placeholder="Enter Full Name">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="mobile_no" class="form-control" id="mobile_no"
                                        ...
                                        maxlength="10" value="<?php echo $sec['mobile_no']; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="type" name="address" class="form-control" id="address"
                                        ...
                                        placeholder="Enter Address" rows="3" value="<?php echo $sec['address']; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="firm_name" id="firm_name"
                                        oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);"
                                        class="form-control" value="<?php echo $sec['firm_name']; ?>"
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a class="btn btn-secondary"
                                        href="<?php echo base_url().'OprId/'.$sec['id'] . '/sec'; ?>"><i
                                            class="fa-solid fa-id-card"></i> Id
                                        Card</a>
                                    <a href="<?php echo base_url() . 'Sec' ?>" class="btn btn-danger"><i
    ...
    <script>
    document.getElementById('page-title').innerHTML = "IOCL  INOUT | SEC";
...
function confirmDelete(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropSec/'.$sec['id'];?>"; // Replace with your delete action or URL
            } else {
