...
<body>
    ...
    <div class="wrapper d-flex overall-body">
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url().'Operation/UpdateContractor'; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="token_no" id="token_no" class="form-control"
                                            value="<?php echo $contractor['token_no']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $contractor['aadhar_no'];?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="aadhar_no" class="form-control"
                                            ...
                                            minlength="12" maxlength="12" id="aadhar_no" required
                                            value="<?php echo $contractor['aadhar_no'] ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name" placeholder="Enter Full Name"
                                            ...
                                            class="form-control" value="<?php echo $contractor['full_name'] ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile_no" id="mobile_no"
                                            ...
                                            value="<?php echo $contractor['mobile_no'] ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" id="address" class="form-control"
                                            ...
                                            placeholder="Enter Address" value="<?php echo $contractor['address'] ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firm_name" id="firm_name" class="form-control"
                                            ...
                                            oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9]/g,'');ws(this.id);"
                                            value="<?php echo $contractor['firm_name'] ?>">
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a class="btn btn-secondary"
                                        href="<?php echo base_url().'OprId/'.$contractor['id'] . '/contractor'; ?>"><i
                                            class="fa-solid fa-id-card"></i> Id
                                        Card</a>
                                    <a href="<?php echo base_url() . 'Contractor'?>" class="btn btn-danger"><i
        ...
        document.getElementById('page-title').innerHTML = "IOCL  INOUT | Contractor";
    ...
    if (!validateContact() || !validateAadharNo() || !validateName() || !validateAddr()) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropContractor/'.$contractor['id'];?>"; // Replace with your delete action or URL
            } else {
