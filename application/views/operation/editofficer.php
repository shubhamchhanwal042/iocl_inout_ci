             ...
             <div class="container-fluid">
                    ...
                    <div class="card border-0 shadow mt-4">
                         <div class="card-body">
                              ...
                              <form method="post" id="myform" action="<?php echo base_url().'Operation/UpdateOfficer'; ?>">
                                   <?php if($officer){?>

                                   <input type="hidden" name="id" value="<?php echo $officer['id']; ?> "
                                   class="form-control">
                                    <input type="hidden" name="oldaadhar" value="<?php echo $officer['aadhar_no'];?>">

                                   <div class="row mt-2">
                                        <div class="col-md-12 mb-4">
                                             <label for="token_no">Token Number :</label>
                                             <input type="text" name="token_no" name="token_no"
                                                  value="<?php echo $officer['token_no']; ?>" class="form-control"
                                   ...
                                   <div class="row">
                                        <div class="col-md-12 mb-4">
                                             ...
                                             <input type="text" name="aadhar_no" id="aadhar_no" class="form-control"
                                                  ...
                                                  minlength="12" maxlength="12" value="<?php echo $officer['aadhar_no']; ?>"
                                   ...
                                   <div class="row">
                                        <div class="col-md-12 mb-4">
                                             ...
                                             <input type="text" name="full_name" id="full_name" class="form-control"
                                                  value="<?php  echo $officer['full_name']; ?>"
                                   ...
                                   <div class="row">
                                        <div class="col-md-12 mb-4">
                                             ...
                                             <input type="text" name="mobile_no" class="form-control" id="mobile_no"
                                                  ...
                                                  minlength="10" maxlength="10" value="<?php echo $officer['mobile_no']; ?>"
                                   ...
                                   <div class="row">
                                        <div class="col-md-12 mb-4">
                                             ...
                                             <textarea name="address" id="address" class="form-control" placeholder="Enter Address"
                                                  rows="3" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);"><?php echo $officer['address']; ?></textarea>
                                   ...
                                   <div class="d-grid gap-2 d-sm-block">
                                        <div>
                                             <button class="btn btn-primary" type="submit"><i
                                                  ...
                                                  <a class="btn btn-secondary" href="<?php echo base_url().'OprId/'.$officer['id'] . '/officer'; ?>"><i
                                                          class="fa-solid fa-id-card"></i> Id
                                                    Card</a>
                                                  <a href="<?php echo base_url() . 'Officer' ?>"  class="btn btn-danger" ><i class="fa-solid fa-arrow-left"></i>
                                                  Back</a>
      ...
      <script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropOfficer/'.$officer['id'];?>"; // Replace with your delete action or URL
            } else {
