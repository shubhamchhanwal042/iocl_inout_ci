            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url().'Operation/UpdateEmployee'; ?>"
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="token_no" id="token_no"
                                        value="<?php echo $employee['token_no']; ?> " class="form-control"
                                        placeholder="Token Number" readonly>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $employee['aadhar_no'];?>">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="mobile_no" id="mobile_no" class="form-control"
                                        ...
                                        maxlength="10" value="<?php echo $employee['mobile_no']; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="address" class="form-control" id="address"
                                        ...
                                        rows="3"><?php echo $employee['address']; ?></textarea>
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a class="btn btn-secondary"
                                        href="<?php echo base_url().'OprId/'.$employee['id'] . '/employee'; ?>"><i
                                            class="fa-solid fa-id-card"></i> Id
                                        Card</a>

                                    <a href="<?php echo base_url() . 'Employee' ?>" class="btn btn-danger"><i
     ...
     function confirmDelete(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropEmployee/'.$employee['id'];?>"; // Replace with your delete action or URL
            } else {
