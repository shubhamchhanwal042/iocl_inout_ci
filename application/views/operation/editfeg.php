            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url().'Operation/UpdateFeg'; ?>"
                            enctype="multipart/form-data">
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    <input type="hidden" name="id" value="<?php echo $feg['id']; ?> "
                                        class="form-control mb-4">

                                    <label for="token_no">Token Number :</label>
                                    <input type="text" name="token_no" value="<?php echo $feg['token_no']; ?> "
                                        class="form-control" placeholder="Token Number" readonly>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $feg['aadhar_no'];?>">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="aadhar_no" id="aadhar_no" class="form-control"
                                        ...
                                        maxlength="12" value="<?php echo $feg['aadhar_no']; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="full_name" id="full_name" class="form-control"
                                        ...
                                        value="<?php echo $feg['full_name']; ?>" placeholder="Enter Full Name">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="mobile_no" id="mobile_no" class="form-control"
                                        ...
                                        maxlength="10" value="<?php echo $feg['mobile_no']; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="address" id="address" class="form-control"
                                        ...
                                        placeholder="Enter Address" rows="3"><?php echo $feg['address']; ?></textarea>
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a class="btn btn-secondary"
                                        href="<?php echo base_url().'OprId/'.$feg['id'] . '/feg'; ?>"><i
                                            class="fa-solid fa-id-card"></i> Id Card</a>

                                    <a href="<?php echo base_url() . 'Feg' ?>" class="btn btn-danger"><i
    ...
    if (!validateContact() || !validateAadharNo() || !validateName() || !validateAddr()) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropFeg/'.$feg['id'];?>"; // Replace with your delete action or URL
            } else {
