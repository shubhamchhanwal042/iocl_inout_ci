            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url() . 'Operation/InsertContractorWorkman' ?>" enctype="multipart/form-data">
                                        ...
                                        <?php 
                                            if(is_array($contractors) || is_object($contractors)){
                                                foreach($contractors as $contractor){
                                                    ?>
                                                    <option value="<?php echo $contractor['id']; ?>"><?php echo $contractor['full_name']; ?></option>
                                                    <?php
                                                }
                                            }
                                        ?>
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a href="<?php echo base_url() . 'ContractorWorkman' ?>" class="btn btn-danger"><i class="fa-solid fa-arrow-left"></i>
                                        Back</a>
                                </div>
