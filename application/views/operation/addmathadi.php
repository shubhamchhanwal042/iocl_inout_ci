...
<body>
   ...
   <div class="card border-0 shadow mt-4">
    <div class="card-body m-4">
            ...
            <form method="post" id="myform" action="<?php echo base_url().'Operation/InsertMathadi'?>" enctype="multipart/form-data">
            <input type="hidden" name="id" id="id" value="<?php echo $id;?>" hidden>

                <div class="row mt-2">
                    <div class="col-md-12 mb-4">
                        <label for="token_no" >Token Number :</label>
                        <input type="text" name="token_no" id="token_no"  value="<?php echo $id;?>" class="form-control" placeholder="Enter Token Number" readonly>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" name="aadhar_no" id="aadhar_no" oninput="this.value=this.value.replace(/[^0-9]/g,'');" size="12" minlength="12" maxlength="12" class="form-control" placeholder="Enter Aadhar Number" required>
                ...
                <a href="<?php echo base_url() . 'Mathadi'?>"  class="btn btn-danger" ><i class="fa-solid fa-arrow-left"></i>
                Back</a>
            </div>
...
document.getElementById('aadhar_no').addEventListener('input', function () {
    ...
    if (aadharNo.length === 12) { // Check if Aadhaar number has 12 digits
        ...
        <script>
          ...
          document.getElementById("navbar-title").innerHTML = "Add Mathadi Form <i class='fa-solid fa-users'></i>";
     </script>
