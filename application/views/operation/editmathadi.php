    ...
    <div class="wrapper d-flex overall-body">
        ...
        <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" id="myform"
                            action="<?php echo base_url().'Operation/UpdateMathadi'; ?>"
                            enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $mathadi['id']; ?>">
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="token_no"><b>Token Number :</b></label>
                                        <input type="text" name="token_no" id="token_no" class="form-control"
                                            value="<?php echo $mathadi['token_no']; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $mathadi['aadhar_no'];?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="aadhar_no" class="form-control"
                                            ...
                                            value="<?php echo $mathadi['aadhar_no'] ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name" placeholder="Enter Full Name"
                                            ...
                                            class="form-control" value="<?php echo $mathadi['full_name'] ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile_no" id="mobile_no"
                                            ...
                                            value="<?php echo $mathadi['mobile_no'] ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" id="address" class="form-control"
                                            ...
                                            value="<?php echo $mathadi['address'] ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firm_name" id="firm_name" class="form-control"
                                            ...
                                            value="<?php echo $mathadi['firm_name'] ?>">
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a class="btn btn-secondary"
                                        href="<?php echo base_url().'OprId/'.$mathadi['id'] . '/mathadi'; ?>"><i
                                            class="fa-solid fa-id-card"></i> Id
                                        Card</a>
                                    <a href="<?php echo base_url() . 'Mathadi' ?>" class="btn btn-danger"><i
            ...
            document.getElementById("navbar-title").innerHTML =
                " Edit Mathadi Form <i class='fa-solid fa-users'></i>";
            </script>
    ...
    <!-- Custom JavaScript -->
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "<?php echo base_url().'DropMathadi/'.$mathadi['id'];?>"; // Replace with your delete action or URL
            } else {
