            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo base_url().'Operation/InsertGat'?>" id="myform" enctype="multipart/form-data">
                        <input type="hidden" name="id" id="id" value="<?php echo $id;?>" hidden>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="token_no" class="form-control"
                                            placeholder="Enter Token Number" id="token_no" value="<?php echo $id;?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div >
                                ...
                                <!-- <button class="btn btn-secondary" name="icard" id="idcard"><i
                                    ...
                                    Card</button> -->
                                    <a href="<?php echo base_url() . 'Gat' ?>"  class="btn btn-danger" ><i class="fa-solid fa-arrow-left"></i>
                                    Back</a>
                            </div>
                        </form>
                    </div>
