...
<body>
    ...
    <div class="wrapper d-flex overall-body">
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4" style="font-family:Poppins,sans-serif; font-size:16px">
                        ...
                        <form method="post" action="<?php echo base_url().'Project/UpdateWorkman'; ?>"
                            enctype="multipart/form-data" id="myform" class="fs-4">
                            <?php if($workman){ ?>

                            <input type="hidden" name="id" value="<?php echo $workman['id']; ?> ">
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="token" class="form-label"><b>Token Number :</b></label>
                                        <input type="text" name="token_no" id="token_no" class="form-control" readonly
                                        value="<?php echo $workman['id']; ?> " >
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $workman['aadhar_no'];?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="aadhar_no" id="aadhar_no" class="form-control"
                                            ...
                                            minlength="12" maxlength="12" value="<?php echo $workman['aadhar_no']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name" class="form-control"
                                            value="<?php echo $workman['full_name']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile_no" class="form-control" id="mobile_no"
                                            ...
                                            minlength="10" maxlength="10" value="<?php echo $workman['mobile_no']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" class="form-control"
                                            ...
                                            rows="3" required
                                            placeholder="Enter Address"><?php echo $workman['address']; ?></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firm_name" id="firm_name"
                                            oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);checkfirm();"
                                            class="form-control" value="<?php echo $workman['firm_name']?>"
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a class="btn btn-secondary" href="<?php echo base_url().'OprId/'.$workman['id'] . '/workman'; ?>"><i class="fa-solid fa-id-card"></i> Id
                                    Card</a>

                                    <a href="<?php echo base_url() . 'Workman' ?>" class="btn btn-danger"><i
                                    ...
                                    <button class="btn btn-danger" name="drop" onclick="confirmDelete(event);"><i
                                            class="fa-solid fa-user-xmark"></i> Drop</button>
        ...
        document.getElementById("navbar-title").innerHTML = "Edit Workman Form <i class='fa-solid fa-users'></i>";
        </script>
...
form.addEventListener('submit', (event) => {
    ...
    //    }
    event.preventDefault();
    window.location.href = "<?php echo base_url() . 'WorkmanIdCard' ?>"
...
function confirmDelete(event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            "<?php echo base_url().'DropWorkman/'.$workman['id'];?>"; // Replace with your delete action or URL
        } else {
