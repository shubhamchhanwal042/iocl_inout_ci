...
<body>
    ...
    <div class="wrapper d-flex overall-body">
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4" style="font-family:Poppins,sans-serif; font-size:16px">
                        ...
                        <form method="post" action="<?php echo base_url().'Project/UpdateAmc'; ?>"
                            enctype="multipart/form-data" id="myform" class="fs-5">
                            <?php if($amc){ ?>

                                <input type="hidden" name="id" value="<?php echo $amc['id']; ?> ">
                                <div class="row mt-2">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="token"><b>Token Number :</b></label>
                                        <input type="text" name="token_no" id="token_no" class="form-control" readonly
                                        value="<?php echo $amc['id']; ?> ">
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" name="oldaadhar" value="<?php echo $amc['aadhar_no'];?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="aadhar_no" id="aadhar_no" class="form-control"
                                            ...
                                            minlength="12" maxlength="12" value="<?php echo $amc['aadhar_no']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile_no" class="form-control" id="mobile_no"
                                            ...
                                            minlength="10" maxlength="10" value="<?php echo $amc['mobile_no']; ?>"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" class="form-control"
                                            ...
                                            rows="3"><?php echo $amc['address']; ?></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firm_name" id="firm_name"
                                            ...
                                            value="<?php echo $amc['firm_name']?>" required>
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    <button type="submit" class="btn btn-primary" id="update"
                                        onclick="isSave(event);"><i class="fa-solid fa-user-pen"></i></i>
                                        Update</button>
                                    <!-- <button class="btn btn-secondary" name="id_card"><i class="fa-solid fa-id-card"></i>  Id Card</button> -->

                                    <a class="btn btn-secondary" href="<?php echo base_url().'OprId/'.$amc['id'] . '/amc'; ?>"><i class="fa-solid fa-id-card"></i> Id
                                    Card</a>

                                    <a href="<?php echo base_url() . 'Amc' ?>" class="btn btn-danger"><i
        ...
        document.getElementById("navbar-title").innerHTML = "Edit AMC Form <i class='fa-solid fa-users'></i>";
        </script>
...
form.addEventListener('submit', (event) => {
    ...
    event.preventDefault();
    window.location.href = "<?php echo base_url().'AmcIdCard'; ?>";
});
</script>
...
function confirmDelete(event) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            "<?php echo base_url().'DropAmc/'.$amc['id'];?>"; // Replace with your delete action or URL
        } else {
