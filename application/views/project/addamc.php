...
<body>
    ...
    <div class="wrapper d-flex overall-body">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                        ...
                        <form method="post" action="<?php echo base_url().'Project/InsertAmc'?>" enctype="multipart/form-data" id="myform" class="fs-5">
                        ...
                        <input type="hidden" name="id" id="id" value="<?php echo $id;?>" hidden>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" name="token_no" id="token_no" value="<?php echo $id ?>"
                       ...
                       <textarea name="address" id="address" class="form-control" rows="3" value="<?php  ?>" placeholder="Enter Address" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);"      required></textarea>
                        <span id="addrerror" style="color: red;"></span>
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    <button type="submit" class="btn btn-primary" id="submit" name="submit"><i
                                            class="fa-solid fa-floppy-disk"></i> Save</button>
                                    <!-- <button class="btn btn-secondary" name="id_card" id="submit"><i
                                            class="fa-solid fa-id-card"></i> Id Card</button> -->
                                            <a href="<?php echo base_url() . 'Amc' ?>"  class="btn btn-danger" ><i class="fa-solid fa-arrow-left"></i>
                                            Back</a>
                                </div>
                            </div>
                        </form>
            ...
            </div> <!-- container-fluid ends here --> <!-- container-fluid ends -->
            <!-- </div> -->
...
function ws(name) { 
    ...
    <script>
        document.getElementById('page-title').innerHTML = "IOCL  INOUT |Add AMC";
        document.getElementById("navbar-title").innerHTML = "Add AMC Form <i class='fa-solid fa-users'></i>";
