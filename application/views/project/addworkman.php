            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                        ...
                        <form method="post" action="<?php echo base_url().'Project/InsertWorkman'?>" enctype="multipart/form-data" id="myform">
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <!-- <button class="btn btn-secondary" name="id_card" id="submit"><i
                                            ...
                                            <a href="<?php echo base_url() . 'Workman' ?>"  class="btn btn-danger" ><i class="fa-solid fa-arrow-left"></i>
                                            Back</a>
                                </div>
                            </div>
                        </form>
...
function ws(name) { 
    ...
    <script>
        ...
        document.getElementById("navbar-title").innerHTML = "Add Workman Form <i class='fa-solid fa-users'></i>";
