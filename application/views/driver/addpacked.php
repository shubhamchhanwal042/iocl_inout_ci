            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                        ...
                        <form method="post" action="<?php echo base_url().'Driver/InsertPacked'?>" id="myform" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="id" id="id" value="<?php echo $id;?>" hidden>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" id="photoid" name="idphoto" value="">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a href="<?php echo base_url() . 'Packed' ?>"  class="btn btn-danger" ><i class="fa-solid fa-arrow-left"></i>
                                    Back</a>
                                </div>
