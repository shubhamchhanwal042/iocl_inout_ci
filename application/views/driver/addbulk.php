            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow mt-4">
                    <div class="card-body m-4">
                        ...
                        <form method="post" id="myform" action="<?php echo base_url() . 'Driver/InsertBulk' ?>" enctype="multipart/form-data">
                            ...
                            <div class="d-grid gap-2 d-sm-block">
                                <div>
                                    ...
                                    <a href="<?php echo base_url() . 'Bulk' ?>" class="btn btn-danger"><i class="fa-solid fa-arrow-left"></i>
                                        Back</a>
                                </div>
