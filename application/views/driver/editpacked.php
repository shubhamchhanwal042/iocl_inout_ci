...
<body>
     ...
     <div class="wrapper d-flex overall-body">
                    ...
                    <div class="card border-0 shadow mt-4">
                         <div class="card-body">
                              ...
                              <form method="post" id="myform"
                                   action="<?php echo base_url() . 'Driver/UpdatePacked'; ?>"
                                   enctype="multipart/form-data">
                                   <?php if ($packed) { ?>

                                        <div class="row mt-2">
                                             <div class="col-md-12 mb-4">
                                                  <input type="hidden" name="id" value="<?php echo $packed['id']; ?> "
                                                       class="form-control">

                                                  <label for="token_no">Token Number :</label>
                                                  <input type="text" name="token_no" id="token_no"
                                                       value="<?php echo $packed['token_no']; ?> " class="form-control"
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="aadhar_no" id="aadhar_no" class="form-control"
                                                       ...
                                                       value="<?php echo $packed['aadhar_no']; ?>"
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="full_name" id="full_name"
                                                       ...
                                                       class="form-control" value="<?php echo $packed['full_name']; ?>"
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="mobile_no" id="mobile_no" class="form-control"
                                                       ...
                                                       minlength="10" maxlength="10" value="<?php echo $packed['mobile_no']; ?>"
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <textarea name="address" id="address" class="form-control" rows="3"
                                                       ...
                                                       placeholder="Enter Address" required><?php echo $packed['address']; ?></textarea>
                                             ...
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="firm_name" id="firm_name" class="form-control"
                                                       ...
                                                       oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);"
                                                       value="<?php echo $packed['firm_name']; ?>" required>
                                             ...
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="truck_no" placeholder="Enter Truck No."
                                                       ...
                                                       class="form-control" value="<?php echo $packed['truck_no']; ?>" required>
                                             ...
                                             <div class="row mb-4 ps-4">
                                                  ...
                                                  <div class="col-md-6">
                                                       ...
                                                       <div id="pic">
                                                            <img src="<?php echo base_url() . $packed['photo']; ?>" alt=""
                                             ...
                                             <div class="row mb-4 ps-4">
                                                  ...
                                                  <div class="col-md-6">
                                                       ...
                                                       <input type="hidden" id="photoid" name="id_proof"
                                                            value="<?php echo $packed['id_proof'] ?>">
                                                  ...
                                                  <div class="col-md-6">
                                                       ...
                                                       <div id="picid">
                                                            <img src="<?php echo base_url() . $packed['id_proof']; ?>" alt=""
                                                                 width="320" height="240">
                                                       </div>
                                                       <br><br>
                                                  </div>
                                        ...
                                        <div class="d-grid gap-2 d-sm-block">
                                             <div>
                                                  ...
                                                  <a class="btn btn-secondary" href="<?php echo base_url() . 'OprId/' . $packed['id'] . '/packed'; ?>">
                                                       <i class="fa-solid fa-id-card"></i>
                                                       Id Card
                                                  </a>

                                                  <a href="<?php echo base_url() . 'Packed' ?>" class="btn btn-danger">
          ...
          <script>
               document.getElementById('page-title').innerHTML = "IOCL  INOUT | Packed Form";
        ...
        name.value = name.value.replace(/^\s+/, '');
          ...
          <script>
               ...
               form.addEventListener('submit', (event) => {
                    ...
                    // }
                    event.preventDefault();
                    window.location.href = "<?php echo base_url() . 'PackedIdCard' ?>";
               ...
               function confirmDelete(event) {
                    ...
                    Swal.fire({
                         ...
                         if (result.isConfirmed) {
                              ...
                              window.location.href = "<?php echo base_url() . 'DropPacked/' . $packed['id']; ?>"; // Replace with your delete action or URL
                         } else {
