...
<body>
     ...
     <div class="wrapper d-flex overall-body">
               ...
               <div class="container-fluid">
                    ...
                    <div class="card border-0 shadow mt-4">
                         <div class="card-body">
                              ...
                              <form method="post" id="myform" action="<?php echo base_url() . 'Driver/UpdateBulk'; ?>"
                                   enctype="multipart/form-data">
                                   <?php if ($bulk) { ?>


                                        <input type="hidden" name="id" value="<?php echo $bulk['id']; ?> "
                                             class="form-control">
                                        ...
                                        <div class="row mt-2">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="token_no" value="<?php echo $bulk['id']; ?> "
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="aadhar_no" class="form-control" id="aadhar_no"
                                                       ...
                                                       minlength="12" maxlength="12" value="<?php echo $bulk['aadhar_no']; ?>"
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="full_name" class="form-control" id="full_name"
                                                       ...
                                                       value="<?php echo $bulk['full_name']; ?>" placeholder="Enter Full Name">
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="mobile_no" class="form-control" id="mobile_no"
                                                       ...
                                                       minlength="10" maxlength="10" value="<?php echo $bulk['mobile_no']; ?>"
                                        ...
                                        <div class="row">
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <textarea name="address" class="form-control" rows="3" id="address" oninput="this.value=this.value.replace(/[^a-z\sA-Z0-9,.-]/g,'');ws(this.id);"
                                                       placeholder="Enter Address" required><?php echo $bulk['address']; ?></textarea>
                                             ...
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" id="firm_name" name="firm_name" class="form-control"
                                                       oninput="this.value=this.value.replace(/[^a-z\sA-Z]/g,'');ws(this.id);"
                                                       value="<?php echo $bulk['firm_name']; ?>" placeholder="Enter Firm Name" required>
                                             ...
                                             <div class="col-md-12 mb-4">
                                                  ...
                                                  <input type="text" name="truck_no" id="truck_no"
                                                       ...
                                                       class="form-control" value="<?php echo $bulk['truck_no']; ?>" placeholder="Enter Truck No" required>
                                             ...
                                             <div class="row mb-4 ps-4">
                                                  ...
                                                  <div class="col-md-6">
                                                       ...
                                                       <div id="pic">
                                                            <img src="<?php echo base_url() . $bulk['photo']; ?>" alt=""
                                             ...
                                             <div class="row mb-4 ps-4">
                                                  ...
                                                  <div class="col-md-6">
                                                       ...
                                                       <div id="picid">
                                                            <img src="<?php echo base_url() . $bulk['id_proof']; ?>" alt=""
                                                                 width="320" height="240">
                                                       </div>
                                                       <br><br>
                                                  </div>
                                        ...
                                        <div class="d-grid gap-2 d-sm-block">
                                             <div>
                                                  ...
                                                  <a class="btn btn-secondary" href="<?php echo base_url() . 'OprId/' . $bulk['id'] . '/bulk'; ?>">
                                                       <i class="fa-solid fa-id-card"></i>
                                                       Id Card
                                                  </a>
                                                  <a href="<?php echo base_url() . 'Bulk' ?>" class="btn btn-danger">
          ...
          <script>
               document.getElementById('page-title').innerHTML = "IOCL  INOUT | Bulk Form";
          ...
          <script>
               ...
               form.addEventListener('submit', (event) => {
                    ...
                    // }
                    event.preventDefault();
                    window.location.href = "<?php echo base_url()  . 'BulkIdCard' ?>";
               ...
               function confirmDelete(event) {
                    ...
                    Swal.fire({
                         ...
                         if (result.isConfirmed) {
                              ...
                              window.location.href = "<?php echo base_url() . 'DropBulk/' . $bulk['id']; ?>"; // Replace with your delete action or URL
                         } else {
