...
<body>
          ...
          <div class="bg-secondary d-flex flex-lg-row flex-md-row flex-column justify-content-between rounded px-3 mb-3  mx-4">
               ...
               <div class="title-div">
                    <p class="text-center align-center mt-4">
                         <span class="label label-default fs-4 bg-danger">License Gate</span>
                    </p>
               </div>
     ...
     <script>
          document.getElementById('page-title').innerHTML = "License Gate";
     </script>
     ...
     <script>
          document.getElementById('qr-field').addEventListener('input', function(event) {
               ...
               fetch('<?php echo base_url('LicenseGate/EnterLicengate'); ?>?unique_value=' + uniqueValue, {
                         method: 'GET',
                         headers: {
