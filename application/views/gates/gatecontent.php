...
<div class="container-fluid">
     <div class="bg-secondary d-flex justify-content-between mb-3 rounded">
          <div class="logo-div pt-2 pb-2 ps-2">
               <a href="">
                    <img src="https://manasvi.tech/demo/assest/img/logos/iocllogo.png" alt="" class="rounded img-fluid"
     ...
     <div class="col-12">
          <div id="error-box" class="alert-box alert alert-danger alert-dismissible fade in">
               ...
               <!-- </a> -->
               <strong id="stre" class="fs-3"></strong> <span>
          ...
          <div id="success-box" class="alert-box alert alert-success alert-dismissible fade in ">
               ...
               <button class="close" data-dismiss="alert" aria-label="close"
                    onclick="window.location.replace('<?php echo $filename; ?>')">&times;</button>
               <!-- </a> -->
               <strong id="strs" class="fs-3"></strong> <span>
                    <?php echo $error_message; ?>
               </span>
          </div>
     </div>
...
<div class="container-fluid"><!--  ps-5 pe-5 pt-5 -->
    ...
    <p class="text-black mb-0 d-flex align-items-center fs-4">
        Powered By : 
        <img src="<?php echo $images_dir . 'Manasvi .png'; ?>" alt="Logo" class="img-fluid mx-2" style="height: 40px;">
