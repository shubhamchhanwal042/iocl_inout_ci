...
<body>
     ...
     <div class="container-fluid">
          <div class="bg-secondary d-flex flex-lg-row flex-md-row flex-column justify-content-between rounded px-3 mb-3  mx-4">
               ...
               <div class="title-div" style="width: 300px; z-index: 1">
     ...
     <script>
          document.getElementById('qr-field').addEventListener('input', function(event) {
               ...
               fetch('<?php echo base_url('DriverLicenseGate/GetExistRecord'); ?>?unique_value=' + uniqueValue, {
                         method: 'GET',
                         headers: {
     ...
     <script>
          document.getElementById('page-title').innerHTML = "Truck License Gate";
     </script>
     <script>
