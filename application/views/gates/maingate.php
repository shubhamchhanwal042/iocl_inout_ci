...
<head>
     ...
     <script src="<?php //echo base_url().'logout.js';
                    ?> "></script>
     <style>
          .alert-box {
               display: none;
...
<body>
     <div class="container-fluid">
          <div class="bg-secondary d-flex flex-lg-row flex-md-row flex-column justify-content-between rounded px-3 mb-3  mx-4">
               ...
               <div class="time-div" style="width: 300px; z-index: 1">
                    <p class="text-light text-center mt-3 fs-2 ">
                         <span id="digiclock" class="fs-3 fw-normal bg-primary label label-default" style="width: 300px;"></span>
                    </p>
          ...
          <?php if (!empty($success_msg)) echo "<p class='text-success'>$success_msg</p>"; ?>
               ...
               <div class="col-12">
                    <div id="error-box" class="alert-box alert alert-danger alert-dismissible fade in">
                         ...
                         <button class="close" data-dismiss="alert" aria-label="close"
                              onclick="window.location.replace('<?php  ?>')">&times;</button>
     ...
     <div id="message-container" style="padding: 10px; margin: 10px 0; border-radius: 5px; font-size: 16px; text-align: center; display: none;"></div>
     ...
     <script>
          document.getElementById('qr-field').addEventListener('input', function(event) {
               ...
               fetch('<?php echo base_url('MainGate/GetExistRecord'); ?>?unique_value=' + uniqueValue, {
                         method: 'GET',
                         headers: {
